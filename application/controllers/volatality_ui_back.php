	...
	*********************************************************/
	...
	{	
		...
		for($i=0 ; $i <= $length-1; $i++)
		{
		    ...
		    $cats[]  = $start_date;
		    $datas[] = $this->volatality_data->volatality_standard_deviation($start_date,$end_date,$company_id);
		}			
			
		$t[0] = array("category"=>$cats);
		$t[1] = array("data"=>$datas);
	    //print_r($cats);
		echo json_encode($t);
	}
