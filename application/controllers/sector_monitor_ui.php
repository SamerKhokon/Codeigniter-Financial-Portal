...
class Sector_monitor_ui extends CI_Controller 
{
    public function index()
    {
       $this->load->model("sector_monitor_data");
       $data['sectors'] = $this->sector_monitor_data->get_sectors();	   
	   $this->load->vars($data);
       $this->load->view("home/sector_monitor_ui_view");
    }
	
	
	public function sector_monitor_json()
	{
	    $this->load->model("sector_monitor_data");
	    ...
	    $datas = $this->sector_monitor_data->get_sector_monitor($indicating_times);
