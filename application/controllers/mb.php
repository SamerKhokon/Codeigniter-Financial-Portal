...
class Mb extends CI_Controller 
{
	...
	*********************************/
	...
	{		
		...
		$prs =	$this->input_form_data->company_sector_by_code_for_combo($company_code);
		$st = explode("#" , $prs);
		$sector = $st[0];
		if($st[1]==""){
		$last_update_date = "no record found";
		}else{
		$last_update_date = date("d,M Y H:i:s",strtotime($st[1]));
		}
		
		echo "&nbsp;<label >Sector:</label>&nbsp;&nbsp; ".$sector.
	...
	?>
	    ...
	    <div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<table id="turnover_entry_table" cellpadding="0" cellspacing="0" >
					...
					<tr>
					    <th >
							<select class="form-control" name="turnover_year" id="turnover_year"  style="width:80px;">
		...
		$(document).ready(function(){
		    ...
		    $("#company_code").change(function()
			{
			    ...
			    if(company_code!="")
				{					
					$("#turnover_datatable").load("<?php echo site_url()?>/input_form_tables/turnover_datatable"
					,{ "company_code":company_code }, function(response, status, xhr){
					     //xhr.abort();
					});
					
										
					$("#net_profit_after_tax_continuing_datatable").load("<?php echo site_url()?>/input_form_tables/net_profit_after_tax_continuing_datatable"
					,{ "company_code":company_code }, function(response, status, xhr){
					   // xhr.abort();
					});
					
					
					$("#net_profit_after_tax_continuing_extra_operation_entry_datatable").load("<?php echo site_url();?>/input_form_tables/net_profit_after_tax_continuing_extra_operation_entry_datatable",
					{ "company_code":company_code } , function(response, status, xhr){
					   // xhr.abort();
					});
			
			
					$("#eps_continuing_operation_manual_entry_form").load("<?php echo site_url();?>/input_form_tables/eps_continuing_operation_manual_entry_form_datatable",
					{ "company_code":company_code } , function(response, status, xhr){
					 // xhr.abort();
					});
					
					
					$("#company_gen_fin_datable").load("<?php echo site_url();?>/input_form_tables/company_gen_fin_datable",
					{ "company_code":company_code } , function(response, status, xhr){
					   //xhr.abort();
					});					
					
					
					$("#diluted_eps_continuing_datatable").load("<?php echo site_url();?>/input_form_tables/diluted_eps_continuing_datatable",
					{ "company_code":company_code } , function(response, status, xhr){
					   //xhr.abort();
					});
					
					
					$("#diluted_eps_extra_datatable").load("<?php echo site_url();?>/input_form_tables/diluted_eps_extra_datatable",
					{ "company_code":company_code } , function(response, status, xhr){
					   //xhr.abort();
					});
										
					
					$("#eps_extra_income_datatable").load("<?php echo site_url();?>/input_form_tables/eps_extra_income_datatable",
					{ "company_code":company_code } , function(response, status, xhr){
					   //xhr.abort();
					});
				...
				else
				{
				   ...
				   $("#turnover_datatable").html("");
				   $("#net_profit_after_tax_continuing_datatable").html("");
				   $("#net_profit_after_tax_continuing_extra_operation_entry_datatable").html("");
				   $("#eps_continuing_operation_manual_entry_form").html("");
				   $("#company_gen_fin_datable").html("");
				   $("#diluted_eps_continuing_datatable").html("");
				   $("#diluted_eps_extra_datatable").html("");
                   $("#eps_extra_income_datatable").html("");				   
				   $("#company_sector").html("");
				}
			});
			...
			<div class="panel-body">
				...
				<table id="net_profit_after_tax_continuing" cellpadding="0" cellspacing="0" >
					...
					<tr>
						...
						<select class="form-control" name="npat_year"  id="npat_year" style="width:80px;">
						  <?php for($i=2000;$i<=2030;$i++){ 
						      if($i==date('Y')){
						?>
						   <option value="<?php echo date('Y');?>" selected="selected"><?php  echo date('Y');?></option>
						...
						<div id="net_profit_after_tax_continuing_datatable"></div>
		...
		$(document).ready(function(){
		    ...
		    $("#npat_save").click(function(){
			   var company_code = $("#company_code").val();
			   var npat_year_con  = $("#npat_year").val();			   
			   var npat_q1_3m_con = [];
				...
				else
				{
					ajax_xhr_09 = $.ajax({
					   ...
					   success:function(st){
						   alert("Data saved successfully");
						$("#net_profit_after_tax_continuing_datatable").load("<?php echo site_url()?>/input_form_tables/net_profit_after_tax_continuing_datatable"
					      ,{ "company_code":company_code }, function(){});
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<table id="net_profit_extra" cellpadding="0" cellspacing="0" >
					...
					<tr>
					    <th ><select class="form-control" name="npat_extra_year"  id="npat_extra_year" style="width:80px;">
						  <?php for($i=2000;$i<=2030;$i++){ 
						      if($i==date('Y')){
						?>
						   <option value="<?php echo date('Y');?>" selected="selected"><?php  echo date('Y');?></option>
					...
					<div id="net_profit_after_tax_continuing_extra_operation_entry_datatable"></div>		
		...
		$(document).ready(function(){
		    ...
		    $("#npat_extra_save").click(function(){
			   var company_code = $("#company_code").val();
			   var npat_extra_year_con  = $("#npat_extra_year").val();
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<table cellpadding="0" cellspacing="0" >
					...
					<tr>
					    <th ><select class="form-control" name="eps_year"   id="eps_year" style="width:80px;">
						     <?php for($i=2000;$i<=2030;$i++){ 
						      if($i==date('Y')){
						?>
						   <option value="<?php echo date('Y');?>" selected="selected"><?php  echo date('Y');?></option>
					...
					<div id="eps_continuing_operation_manual_entry_form"></div>
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<table cellpadding="0" cellspacing="0" >					
					...
					<tr>
					    <th ><select class="form-control" name="gen_fin_year" id="gen_fin_year" style="width:80px;">
				  <?php for($i=2000;$i<=2030;$i++){ 
						      if($i==date('Y')){
						?>
						   <option value="<?php echo date('Y');?>" selected="selected"><?php  echo date('Y');?></option>
				...
				<div id="company_gen_fin_datable"></div>
		...
		$(document).ready(function(){
		    ...
		    $("#gen_fin_save").click(function(){
			   var company_code = $("#company_code").val();
			   var gen_fin_year_con  = $("#gen_fin_year").val();
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<table cellpadding="0" cellspacing="0" >
					...
					<tr>
					    <th ><select class="form-control" name="diluted_eps_year"   id="diluted_eps_year" style="width:80px;">
						  <?php for($i=2000;$i<=2030;$i++){ 
						      if($i==date('Y')){
						?>
						   <option value="<?php echo date('Y');?>" selected="selected"><?php  echo date('Y');?></option>
				...
				<div id="diluted_eps_continuing_datatable"></div>	
		...
		$(document).ready(function(){
		    ...
		    $("#diluted_eps_save").click(function(){
			   var company_code = $("#company_code").val();
			   var diluted_eps_year_con  = $("#diluted_eps_year").val();
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<table cellpadding="0" cellspacing="0" >
					...
					<tr>
					    <th >
						<select class="form-control" name="diluted_eps_extra_year"   id="diluted_eps_extra_year" style="width:80px;">
						  <?php for($i=2000;$i<=2030;$i++){ 
						      if($i==date('Y')){
						?>
						   <option value="<?php echo date('Y');?>" selected="selected"><?php  echo date('Y');?></option>
				...
				<div id="diluted_eps_extra_datatable"></div>
		...
		$(document).ready(function(){
		    ...
		    $("#diluted_eps_extra_save").click(function(){
			   var company_code = $("#company_code").val();
			   var diluted_eps_extra_year_con  = $("#diluted_eps_extra_year").val();
			   var diluted_eps_extra_q1_3m_con = $("#").val();
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<table cellpadding="0" cellspacing="0" >
					...
					<tr>
					    <th ><select class="form-control"  name="eps_extra_income_year" id="eps_extra_income_q4_12m" style="width:80px;">
						  <?php for($i=2000;$i<=2030;$i++){ 
						      if($i==date('Y')){
						?>
						   <option value="<?php echo date('Y');?>" selected="selected"><?php  echo date('Y');?></option>
				...
				<div id="eps_extra_income_datatable"></div>
		...
		$(document).ready(function(){
		    ...
		    $("#eps_extra_income_save").click(function(){
			   var company_code = $("#company_code").val();
			   var eps_extra_income_year_con  = $("#eps_extra_income_year").val();
...
<?php 	
	...
	?>
		...
		<div class="panel panel-primary" style="width:120%">
			...
			<div class="panel-body">
				...
				<table width="120%" cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
					  <th style="font-size:10px;text-align:center;width:90px;"><select class="form-control" name="divident_mutual_year" id="divident_mutual_year">
					    <?php 
								for($i=2000;$i<=2030;$i++)
								{
						            if($i==date('Y')) {
				...
				<div id="dividend_entry_datatable"></div>
		...
		$(document).ready(function(){
		    var dividend_ajx;
			var dividend_entry_ajx;
			
		    $("#weekly_company_code").change(function(ex){
			  var company_codes = $("#weekly_company_code").val();
			  if(company_codes!="") {
			     //alert(company_codes);
					$("#dividend_entry_datatable").load("<?php echo site_url();?>/input_form_tables/dividend_info_entry_datatable",
					{"company_code":company_codes},function(response , status , xhr_01){ 
					        xhr_01.abort();
					});
			  }else{
					$("#dividend_entry_datatable").html("");
			  }
			});
			...
			$("#divident_mutual_save").click(function(){
				...
				var divident_mutual_year_con = $("#divident_mutual_year").val();
				   ...
				   return false;
					...
					dividend_entry_ajx = $.ajax({
					   ...
					   success:function(st)
					   {
							...
							$("#dividend_entry_datatable").load("<?php echo site_url();?>/input_form_tables/dividend_info_entry_datatable",
							{"company_code":company_codes},function(response , status , xhr){
							     xhr.abort();
							});
					   },complete:function(xhr ,status ){
					        dividend_entry_ajx = null;
					        dividend_entry_ajx.abort();
					   }
					});
